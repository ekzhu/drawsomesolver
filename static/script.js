...
// Insert 'FindWords' as the name of a callable method
InstallFunction(server, 'FindWords');
...
function doFindWords() {
  server.FindWords($('input-letters').value, $('input-length').value, onFindWordsSuccess);
}

// Callback for after a successful doFindWords
function onFindWordsSuccess(response) {
